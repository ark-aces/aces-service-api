...
namespace ArkAces.AcesServiceApi.Model
{
    ...
    public partial class Contract :  IEquatable<Contract>, IValidatableObject
    {
        ...
        /// <param name="Results">Contract results data..</param>
        public Contract(string Id = default(string), DateTime? CreatedAt = default(DateTime?), DateTime? ExpiresAt = default(DateTime?), string CorrelationId = default(string), StatusEnum? Status = default(StatusEnum?), Object Results = default(Object))
        {
            this.Id = Id;
        ...
        /// </summary>
        /// <value>Contract results data.</value>
