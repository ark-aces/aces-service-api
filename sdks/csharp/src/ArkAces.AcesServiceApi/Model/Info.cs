...
namespace ArkAces.AcesServiceApi.Model
{
    ...
    public partial class Info :  IEquatable<Info>, IValidatableObject
    {
        ...
        /// <param name="InputSchema">Contract input schema in JSON Schema format..</param>
        /// <param name="OutputSchema">Contract output schema in JSON Schema format..</param>
        /// <param name="Interfaces">Interfaces.</param>
        public Info(string Name = default(string), string Description = default(string), string Instructions = default(string), List<Capacity> Capacities = default(List<Capacity>), string FlatFee = default(string), string PercentFee = default(string), Object InputSchema = default(Object), Object OutputSchema = default(Object), List<ModelInterface> Interfaces = default(List<ModelInterface>))
        {
            this.Name = Name;
        ...
        /// </summary>
        /// <value>Contract output schema in JSON Schema format.</value>
