...
// APIClient manages communication with the Aces Service API API v1.0.0
...
type APIClient struct {
	...
	common 	service 		// Reuse a single struct instead of allocating one for each service on the heap.
	 ...
	 // API Services
	AcesServiceApi	*AcesServiceApiService
}
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	// API Services
	c.AcesServiceApi = (*AcesServiceApiService)(&c.common)
