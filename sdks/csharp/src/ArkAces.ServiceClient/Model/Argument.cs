...
namespace ArkAces.ServiceClient.Model
{
    ...
    public partial class Argument :  IEquatable<Argument>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="Name">Argument name matching a parameter in service contract schema..</param>
        /// <param name="Value">Arugment value..</param>
        public Argument(string Name = default(string), Object Value = default(Object))
        {
            this.Name = Name;
            this.Value = Value;
        }
        ...
        /// </summary>
        /// <value>Argument name matching a parameter in service contract schema.</value>
