...
namespace ArkAces.ServiceClient.Api
{
    /// <summary>
    ...
    public interface IDefaultApi : IApiAccessor
    {
        ...
        /// </remarks>
        /// <exception cref="ArkAces.ServiceClient.Client.ApiException">Thrown when fails to make API call</exception>
        ...
        ApiResponse<Info> InfoGetWithHttpInfo ();
        /// <summary>
        /// Get Health of node.
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<Info> InfoGetAsync ();
        ...
        System.Threading.Tasks.Task<ApiResponse<Info>> InfoGetAsyncWithHttpInfo ();
        /// <summary>
        /// Get Health of node.
        /// </summary>
        /// <remarks>
    ...
    {
        private ArkAces.ServiceClient.Client.ExceptionFactory _exceptionFactory = (name, response) => null;
        ...
        public DefaultApi(String basePath)
        {
            ...
            ExceptionFactory = ArkAces.ServiceClient.Client.Configuration.DefaultExceptionFactory;
        }
        ...
        /// </summary>
        public ArkAces.ServiceClient.Client.ExceptionFactory ExceptionFactory
        {
            get
            {
        ...
        public ApiResponse< Contract > ContractsIdGetWithHttpInfo (string id)
        {
            ...
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling DefaultApi->ContractsIdGet");
        ...
        public Info InfoGet ()
        {
             ApiResponse<Info> localVarResponse = InfoGetWithHttpInfo();
             return localVarResponse.Data;
        }
        ...
        /// <exception cref="ArkAces.ServiceClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>ApiResponse of Info</returns>
        public ApiResponse< Info > InfoGetWithHttpInfo ()
        {
        ...
        /// <exception cref="ArkAces.ServiceClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>Task of Info</returns>
        public async System.Threading.Tasks.Task<Info> InfoGetAsync ()
        {
             ApiResponse<Info> localVarResponse = await InfoGetAsyncWithHttpInfo();
             return localVarResponse.Data;
        ...
        /// <exception cref="ArkAces.ServiceClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>Task of ApiResponse (Info)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Info>> InfoGetAsyncWithHttpInfo ()
        {
