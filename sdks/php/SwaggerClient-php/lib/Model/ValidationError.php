...
class ValidationError implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'code' => 'string',
        'message' => 'string',
        'fieldErrors' => '\ArkAces\ServiceClient\Model\FieldError[]'
    ];
     ...
     * Gets fieldErrors
     *
     * @return \ArkAces\ServiceClient\Model\FieldError[]
     */
     ...
     * Sets fieldErrors
     *
     * @param \ArkAces\ServiceClient\Model\FieldError[] $fieldErrors fieldErrors
     *
     * @return $this
     */
